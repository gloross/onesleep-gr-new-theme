      ...
      737: () => {
        ...
        if ('instantIntensity' in document.body.dataset)
          if ('mousedown' == document.body.dataset.instantIntensity.substr(0, 9))
            (u = !0), 'mousedown-only' == document.body.dataset.instantIntensity && (l = !0);
          else {
            ...
            u
              ? document.addEventListener(
                  ...
                  function (e) {
                    ...
                    if (!h(n)) return;
                    n.addEventListener('mouseout', p, {passive: !0}), (t = n.href), m(n.href);
                  },
                  a
                )
              : document.addEventListener(
